...
describe('post, get and delete api for new pet', () => {
            ...
            cy.request({
                ...
                cy.request({
                    ...
                    cy.request({
                        ...
                        expect(res.body).has.property('message', petId.toString())
                    })
                })
            })
        })
    })
    it('404 Not Found for delete PET', () => {
        cy.fixture('createPet').then((payload) => {
            cy.request({
                method: "DELETE",
                url: "https://petstore.swagger.io/v2/pet/" + payload.id,
                header: {
                    "accept": "application/json"
                },
